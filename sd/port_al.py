...
def main():
    ...
    try:
        ...
        print("===== Backtesting Results [1st March to 28th March 2026] =====")
        print(f"Basket Mean Return: {df['Mean_return'].mean()} & SP500 Mean Return: {df['SPY_Return'].mean()} & Nasdaq Mean Return: {df['IXIC_Return'].mean()}")
        ...
        print("")
        print("===== Comparison with Original 3 Tickers (without NFLX) =====")
